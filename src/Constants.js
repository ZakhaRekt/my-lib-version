 ...
 *
 * @property {string} [giveaway='@everyone\n\n🎉🎉 **Розыгрыш** 🎉🎉'] Displayed above the giveaway embed when the giveaway is running.
 ...
 * @property {string} [endedAt='Закончится в'] Displayed next to the embed footer, used to display the giveaway end date.
 * @property {string} [hostedBy='Розыгрыш от пользователя: {user}'] Below the inviteToParticipate message, in the description of the embed.
...
exports.defaultGiveawayMessages = {
    ...
    winners: 'победителей',
    endedAt: 'Закончится в',
    hostedBy: 'Розыгрыш от пользователя: {user}',
    units: {
        seconds: 'seconds',
        minutes: 'minutes',
        hours: 'hours',
...
exports.LastChanceOptions = {
    enabled: false,
    content: '⚠️ **ПОСЛЕДНИЙ ШАНС ПОУЧАСТВОВАТЬ !** ⚠️',
    threshold: 5000,
    embedColor: '#FF0000'
};
 ...
 * @property {string} [messages.congrat=':tada: New - победителей: {winners}! Congratulations, you won **{prize}**!\n{messageURL}'] The message used if there are winners
 * @property {string} [messages.error='No valid participations, no new - победителей can be chosen!'] The message used if no winner can be choosen
 */
...
exports.defaultRerollOptions = {
    winnerCount: null,
    messages: {
        congrat: ':tada: New - победителей: {winners}! Congratulations, you won **{prize}**!\n{messageURL}',
        error: 'No valid participations, no new - победителей can be chosen!'
    }
};
